...
// ✅ Save Help Center Offers
app.post("/api/offers", async (req, res) => {
  const { adminEmail, user, tasks, type, expireInMinutes } = req.body;

  if (!adminEmail || !user || !tasks || !type || !expireInMinutes) {
